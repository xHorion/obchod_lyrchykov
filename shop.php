...
<html lang="en">
  ...
  <head>
    ...
    <title>DotaShop - Shop Page</title>
  ...
  <div class="section trending">
    <div class="container">
      <ul class="trending-filter">
        <li>
          <a class="is_active" href="#!" data-filter="*">Zobraziť všetko</a>
        </li>
        <li>
          <a href="#!" data-filter=".adv">Účty Dota 2</a>
        </li>
        <li>
          <a href="#!" data-filter=".str">Predmety</a>
        </li>
        <li>
          <a href="#!" data-filter=".rac">Súpravy</a>
        </li>
      </ul>
      <div class="row trending-box">
        <div class="col-lg-3 col-md-6 align-self-center mb-30 trending-items col-md-6 adv">
          <div class="item">
            ...
            <div class="down-content">
              ...
              <h4>Učet s immortal kožou na Axe(exkluzívne) </h4>
        ...
        <div class="col-lg-3 col-md-6 align-self-center mb-30 trending-items col-md-6 adv rac">
          <div class="item">
            ...
            <div class="down-content">
              <span class="category">Akcia</span>
              <h4>Učet s arcanou na Drow Ranger</h4>
              <a href="product-details.php"><i class="fa fa-shopping-bag"></i></a>
            </div>
          </div>
        </div>
        <div class="col-lg-3 col-md-6 align-self-center mb-30 trending-items col-md-6 str">
          <div class="item">
            ...
            <div class="down-content">
              <span class="category">Akcia</span>
              <h4>Immortal topanky na Kunnka</h4>
              <a href="product-details.php"><i class="fa fa-shopping-bag"></i></a>
            </div>
          </div>
        </div>
        <div class="col-lg-3 col-md-6 align-self-center mb-30 trending-items col-md-6 rac str">
          <div class="item">
            ...
            <div class="down-content">
              <span class="category">Akcia</span>
              <h4>Zbrane pre Phantom Assasin(exsklusivne)</h4>
              <a href="product-details.php"><i class="fa fa-shopping-bag"></i></a>
            </div>
          </div>
        </div>
        <div class="col-lg-3 col-md-6 align-self-center mb-30 trending-items col-md-6 rac adv">
          <div class="item">
            ...
            <div class="down-content">
              <span class="category">Akcia</span>
              <h4>Učet s arcanou na Windranger</h4>
              <a href="product-details.php"><i class="fa fa-shopping-bag"></i></a>
            </div>
          </div>
        </div>
        <div class="col-lg-3 col-md-6 align-self-center mb-30 trending-items col-md-6 rac str">
          <div class="item">
            ...
            <div class="down-content">
              <span class="category">Akcia</span>
              <h4>Exsklusivne kourier "Amaterasu"</h4>
              <a href="product-details.php"><i class="fa fa-shopping-bag"></i></a>
            </div>
          </div>
        </div>
        <div class="col-lg-3 col-md-6 align-self-center mb-30 trending-items col-md-6 rac adv">
          <div class="item">
            ...
            <div class="down-content">
              <span class="category">Akcia</span>
              <h4>Učet s arcanou na Spectre</h4>
              <a href="product-details.php"><i class="fa fa-shopping-bag"></i></a>
            </div>
          </div>
        </div>
        ...
        <div class="col-lg-3 col-md-6 align-self-center mb-30 trending-items col-md-6 str">
          <div class="item">
            <div class="thumb">
              <a href="product-details.php"><img src="assets/images/maxresdefault.jpg" alt=""></a>
              <span class="price"><em>$26</em>$18</span>
            </div>
            <div class="down-content">
              <span class="category">Akcia</span>
              <h4>Ruleta (dodatočná položka pri kúpe akéhokoľvek účtu)</h4>
              <a href="product-details.php"><i class="fa fa-shopping-bag"></i></a>
            </div>
          </div>
        </div>
        ...
        <div class="col-lg-3 col-md-6 align-self-center mb-30 trending-items col-md-6 str">
          <div class="item">
            ...
            <div class="down-content">
              <span class="category">Akcia</span>
              <h4>Učet s arcanou na Pudge + náhodná koža</h4>
              <a href="product-details.php"><i class="fa fa-shopping-bag"></i></a>
            </div>
          </div>
        </div>
