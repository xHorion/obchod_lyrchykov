...
<html lang="en">
  ...
  <head>
    ...
    <title>DotaShop - najlepše obchod na svete</title>
      ...
      <div class="row">
        <div class="col-lg-6 align-self-center">
          <div class="caption header-text">
            <h6>Vitame v DotaShop</h6>
            <h2>Najlepši obchod DOTA 2!</h2>
            <div class="search-input">
              <form id="search" action="#">
                <input type="text" placeholder="Type Something" id='searchText' name="searchKeyword" onkeypress="handle" />
                <button role="button">Hladať</button>
              </form>
            </div>
          </div>
        </div>
        <div class="col-lg-4 offset-lg-2">
          <div class="right-image">
            <img src="assets/images/Cosmetic_icon_Manifold_Paradox_3.webp" alt="">
          ...
          <div class="subscribe">
            <div class="row">
              <div class="col-lg-12">
                <div class="section-heading">
                  <h6>Zásielky</h6>
                  <h2>Získajte až 100 dolárov z jednoduchého nákupu <em>Predplaťte si</em> Zasielky</h2>
                </div>
                <div class="search-input">
